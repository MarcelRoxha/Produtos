        ...
        <div class="box-insertP">
            <div class="row">
                <div class="col-md-6 insert-produto">
                    ...
                    <div enctype="multipart/form-data" class="text-center">
                        <label label>Selecione a imagem</label>
                        <input type="file" id="image" accept="image/*"></input><br><br>
                        <button type="button" class="btn btn-success" id="comfirmarFoto" onclick="salvarImagemFirebase()">Confirmar</button> <br><br>
